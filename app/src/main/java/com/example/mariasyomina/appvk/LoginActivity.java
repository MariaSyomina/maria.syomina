...
import static com.example.mariasyomina.appvk.R.id.sign_in_button;


/**
 * Created by mariasyomina on 08.03.15.
 */
public class LoginActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VKSdk.initialize(sdkListener, "4817610");
    ...
    public static class LoginFragment extends android.support.v4.app.Fragment {
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            getView().findViewById(sign_in_button).setOnClickListener(new View.OnClickListener() {
                @Override
